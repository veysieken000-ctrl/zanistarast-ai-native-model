...
export function buildDemoCampaign(){
 ...
 const ledger=createAdSourceLedger({campaignId:campaign.campaignId,campaignVersion:campaign.version,sources:[{sourceId:"src-1",origin:"MIRA_INTERNAL",rightsStatus:"CLEARED",reference:"demo-only"}],claims:[{claimId:"claim-1",text:"DEMO TANITIM",status:"SUPPORTED",sourceIds:["src-1"]}]});
 const handoff=miraCreativeHandoff(ledger,{creativeId:"demo-h9-creative",version:"creative-v1",brief:"H9 governed demo creative"});
